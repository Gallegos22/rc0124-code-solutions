...
function renderPokemon(pokemon) {
  console.log(pokemon);
  const colOneThird = document.createElement('div'); // create an element
  colOneThird.setAttribute('class', 'column-third'); // set class attribute of element
